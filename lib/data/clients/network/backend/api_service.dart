...
class ApiDioClient implements ApiClientBase {
  ...
  void _log(String message,
      {String? methodName, Object? error, StackTrace? stackTrace}) {
    log(
      message,
  ...
  Future<T> get<T>(
    ...
    try {
      ...
      _log('GET Request successful, response-> $response ',
          methodName: endpoint);
  ...
  Future<T> post<T>(
    ...
    try {
      ...
      _log('POST Request successful, response-> $response ',
          methodName: endpoint);
      return fromJson(response.data);
    } on DioException catch (e) {
      _log(
  ...
  Future<T> put<T>(
    ...
    try {
      ...
      _log('PUT Request successful, response-> $response ',
          methodName: endpoint);
      return fromJson(response.data);
    } on DioException catch (e) {
      _log(
  ...
  Future<T> patch<T>(
    ...
    try {
      ...
      _log('PATCH Request successful, response-> $response ',
          methodName: endpoint);
      return fromJson(response.data);
    } on DioException catch (e) {
      _log(
  ...
  Future<T> delete<T>(
    ...
    try {
      ...
      _log('DELETE Request successful, response-> $response ',
          methodName: endpoint);
      return fromJson(response.data);
    } on DioException catch (e) {
      _log(
  ...
  Future<T> uploadFile<T>(
    ...
    try {
      ...
      _log('UPLOAD Request successful, response-> $response ',
          methodName: endpoint);
      return fromJson(response.data);
    } on DioException catch (e) {
      _log(
