...
class NetworkException implements Exception {
  ...
  factory NetworkException.fromStatusCode(int statusCode, [String? customMessage]) {
    switch (statusCode) {
      case 400:
  ...
  factory NetworkException.validationError(String message, [Map<String, dynamic>? details]) {
    return NetworkException(
